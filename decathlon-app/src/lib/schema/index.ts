...
export const product_category = sequelize.define(
	'product_category',
	{
...
export const product_range = sequelize.define(
	'product_range',
	{
		// Model attributes are defined here
		name: {
...
export const product_image = sequelize.define(
	'product_image',
	{
		// Model attributes are defined here
		cover: {
...
export const product_inventory = sequelize.define(
	'product_inventory',
	{
		// Model attributes are defined here
		qty: {
...
export const user_adress = sequelize.define(
	'user_adress',
	{
		// Model attributes are defined here
		adressLine1: {
...
export const shopping_session = sequelize.define(
	'shopping_session',
	{
		// Model attributes are defined here
		total: {
...
export const track_time = sequelize.define(
	'track_time',
	{
		// Model attributes are defined here
		spentTime: {
...
export const payment_detail = sequelize.define(
	'payment_detail',
	{
		// Model attributes are defined here
		amount: {
...
export const user_payment = sequelize.define(
	'user_payment',
	{
		// Model attributes are defined here
		paymentType: {
